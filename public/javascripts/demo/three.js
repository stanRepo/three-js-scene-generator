...
for(let i=0;i<slicedImages[0].length;i++){
 ...
 // rearrange the tiles so the image is correctly rendered
      ...
      // set position
        ...
        // const vector = new THREE.Vector3(Math.random,Math.random(),Math.random())
        //         cube.translateOnAxis(vector, Math.random());
}
...
var render = function (time) {
    ...
    group.children.forEach((child, i)=>{
        ...
        // // Move position Randomly animation
        // const count = Math.random()
        // if(count<= 0.5){
        //     child.position.y -= Math.random() / 1000
